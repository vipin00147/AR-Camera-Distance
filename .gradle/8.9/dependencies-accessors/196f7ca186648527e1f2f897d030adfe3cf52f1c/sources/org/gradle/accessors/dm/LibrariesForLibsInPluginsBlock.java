...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ArLibraryAccessors laccForArLibraryAccessors = new ArLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>ar</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ArLibraryAccessors getAr() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForArLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class ArLibraryAccessors extends SubDependencyFactory {

        public ArLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class KotlinStdlibLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>jdk7</b> with <b>org.jetbrains.kotlin:kotlin-stdlib-jdk7</b> coordinates and
         * with version reference <b>kotlinStdlibJdk7</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class QuickieLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>unbundled</b> with <b>io.github.g00fy2.quickie:quickie-unbundled</b> coordinates and
         * with version reference <b>quickieUnbundled</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getUnbundled() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("quickie.unbundled");
        }
    ...
    public static class SceneformLibraryAccessors extends SubDependencyFactory {
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getUx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>core</b> with value <b>1.17.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>coreVersion</b> with value <b>1.46.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinStdlibJdk7</b> with value <b>1.9.24</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinStdlibJdk7() { return getVersion("kotlinStdlibJdk7"); }
        ...
        /**
         * Version alias <b>quickieUnbundled</b> with value <b>1.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getQuickieUnbundled() { return getVersion("quickieUnbundled"); }
